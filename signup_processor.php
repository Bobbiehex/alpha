...
$sql = "INSERT INTO alpha_table(email_id, full_name, password_1, date_registered) VALUES(:email_id, :full_name, :password_1, now())";
$stmt = $pdo->prepare($sql);
// $stmt->execute(["email_id"=>$email_id, "full_name"=>$full_name, "password_1"=>$password_1]);
$stmt->execute(["email_id"=>$email_id, "full_name"=>$full_name, "password_1"=>md5($password_1)]);
$count = $stmt->rowCount();
